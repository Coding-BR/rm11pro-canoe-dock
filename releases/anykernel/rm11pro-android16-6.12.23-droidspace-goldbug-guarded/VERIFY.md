...
```bash
sha256sum AK3_RM11Pro_Android16_6.12.23_Droidspace-Goldbug_Guarded_2026-06-16.zip
```
...
```bash
unzip -p AK3_RM11Pro_Android16_6.12.23_Droidspace-Goldbug_Guarded_2026-06-16.zip anykernel.sh | grep -E 'do.devicecheck=1|PATCH_VBMETA_FLAG=0|NX809J|6.12.23'
```
...
unzip -q AK3_RM11Pro_Android16_6.12.23_Droidspace-Goldbug_Guarded_2026-06-16.zip Image anykernel.sh -d /tmp/rm11-ak3-check
